...
def behandle():
    ...
    barnehager = pd.read_excel(r'C:\OBLIG-5\IS-114-OBLIG_5\barnehage\kgdata.xlsx', sheet_name='barnehage')
...
@app.route('/commit')
def commit():
    all_data = pd.read_excel(r'C:\OBLIG-5\IS-114-OBLIG-5\barnehage\kgdata.xlsx', sheet_name=None)  # Leser alle ark
...
def statistikk():
    ...
    try:
        ...
        file_path = r'C:\OBLIG-5\IS-114-OBLIG-5\barnehage\barnehagedata.xlsm'
